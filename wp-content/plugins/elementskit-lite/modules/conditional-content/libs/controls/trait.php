...
namespace ElementsKit_Lite\Modules\Conditional_Content\Libs\Controls;
...
trait Extra
{
    ...
    protected function get_class_name($control, $namespace = 'ElementsKit_Lite\Modules\Conditional_Content\Libs\\Controls')
    {
    ...
    protected function create_class()
    {
        ...
        $class_name = $this->get_class_name($this->config['condition_name'], 'ElementsKit_Lite\Modules\Conditional_Content\Libs\\Conditions');
